    ...
    <div className="flex flex-col lg:flex-row lg:gap-10 lg:ml-20 lg:mt-9 p-4">
      ...
      <div className="mt-4 lg:mt-10 lg:ml-10 flex-1">
        ...
        <div className="flex gap-4 lg:gap-6 mt-5">
          <button
            className="bg-[#333333] w-full lg:w-28 h-12 lg:h-14 rounded-lg text-white text-sm lg:text-base hover:bg-black transition-transform transform hover:scale-105"
            onClick={lgram}
          >
            500gm
          </button>
        ...
        <button className="bg-[#333333] w-full lg:w-80 h-12 lg:h-14 mt-5 rounded-lg text-white text-sm lg:text-base font-semibold hover:bg-black transition-transform transform hover:scale-105 shadow-md">
          Rs {gram}
        </button>

        <div className="flex flex-row xs:flex-row sm:flex-row md:flex-row gap-4 lg:gap-5 mt-5">
          <button
            className="bg-teal-800 w-full xs:w-1/2 sm:w-1/2 md:w-1/2 lg:w-80 h-12 lg:h-14 rounded-lg text-white text-sm lg:text-base font-semibold hover:bg-teal-700 transition-transform transform hover:scale-105 shadow-md"
        ...
        <p className="mt-6 text-sm lg:text-base text-gray-600">
          <span className="font-semibold">Farmer:</span> {username} - A trusted farmer providing high-quality {productname}. Available in {gram}gm at a competitive price of Rs {gram}. 
